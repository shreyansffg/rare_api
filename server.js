...
app.post('/admin/addChallenge', function(req, res){
	console.log(req);
    DB.addChallenge(req.query.challengeName, req.query.startDate, req.query.endDate, req.query.active,req.query.hashtagName, req.query.mediaType, req.query.multiplier, req.query.description, req.query.instructions,req.query.max_points);
